...
| SisdaiCampoBase            | Campo de entrada con funciones de accesibilidad básica ajustadas.                                                                                     | etiqueta="`texto`" tipo="`texto`" ejemplo="`texto`" texto_ayuda="`texto`" texto_error="`texto`" :es_etiqueta_visible="`boleano`" :es_obligatorio="`boleano`"  | NA                                                               |
